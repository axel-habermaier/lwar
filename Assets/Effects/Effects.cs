...
namespace Lwar.Assets.Effects
{
	public sealed class BlurEffect
	{
		...
		public BlurEffect(GraphicsDevice graphicsDevice, AssetsManager assets)
		{
			...
			_vertexShader = assets.LoadVertexShader("Effects/Lwar.Assets.Effects.BlurEffect.VertexShader");
			_horizontalBlur = assets.LoadFragmentShader("Effects/Lwar.Assets.Effects.BlurEffect.HorizontalBlur");
			_verticalBlur = assets.LoadFragmentShader("Effects/Lwar.Assets.Effects.BlurEffect.VerticalBlur");
		}
...
namespace Lwar.Assets.Effects
{
	public sealed class SkyboxEffect
	{
		...
		public SkyboxEffect(GraphicsDevice graphicsDevice, AssetsManager assets)
		{
			...
			_vertexShader = assets.LoadVertexShader("Effects/Lwar.Assets.Effects.SkyboxEffect.VertexShader");
			_fragmentShader = assets.LoadFragmentShader("Effects/Lwar.Assets.Effects.SkyboxEffect.FragmentShader");
		}
...
namespace Lwar.Assets.Effects
{
	public sealed class SphereEffect
	{
		...
		public SphereEffect(GraphicsDevice graphicsDevice, AssetsManager assets)
		{
			...
			_vertexShader = assets.LoadVertexShader("Effects/Lwar.Assets.Effects.SphereEffect.VertexShader");
			_fragmentShader = assets.LoadFragmentShader("Effects/Lwar.Assets.Effects.SphereEffect.FragmentShader");
...
namespace Lwar.Assets.Effects
{
	public sealed class SpriteEffect
	{
		...
		public SpriteEffect(GraphicsDevice graphicsDevice, AssetsManager assets)
		{
			...
			_vertexShader = assets.LoadVertexShader("Effects/Lwar.Assets.Effects.SpriteEffect.VertexShader");
			_fragmentShader = assets.LoadFragmentShader("Effects/Lwar.Assets.Effects.SpriteEffect.FragmentShader");
...
namespace Lwar.Assets.Effects
{
	public sealed class SunEffect
	{
		...
		public SunEffect(GraphicsDevice graphicsDevice, AssetsManager assets)
		{
			...
			_vertexShader = assets.LoadVertexShader("Effects/Lwar.Assets.Effects.SunEffect.VertexShader");
			_fragmentShader = assets.LoadFragmentShader("Effects/Lwar.Assets.Effects.SunEffect.FragmentShader");
...
namespace Lwar.Assets.Effects
{
	public sealed class TexturedQuadEffect
	{
		...
		public TexturedQuadEffect(GraphicsDevice graphicsDevice, AssetsManager assets)
		{
			...
			_vertexShader = assets.LoadVertexShader("Effects/Lwar.Assets.Effects.TexturedQuadEffect.VertexShader");
			_fragmentShader = assets.LoadFragmentShader("Effects/Lwar.Assets.Effects.TexturedQuadEffect.FragmentShader");
