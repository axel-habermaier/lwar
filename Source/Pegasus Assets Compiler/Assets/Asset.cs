namespace Pegasus.AssetsCompiler.Assets
{
	...
	public abstract class Asset : DisposableObject
	{
		...
		/// <summary>
		/// The context the asset is compiled in.
		/// </summary>
		...
		protected Asset(CompilationContext context, string relativePath, bool doNotCreateTargetPath = false)
			: this(context, relativePath, context.SourceDirectory, doNotCreateTargetPath)
		{
		}
		...
		/// <param name="doNotCreateTargetPath">If true, the target path for the asset is not created.</param>
		protected Asset(CompilationContext context, string relativePath, string sourceDirectory, bool doNotCreateTargetPath = false)
		{
		...
		/// <summary>
		///     Gets the relative path to the asset in the target directory, i.e. Textures/Tex.{ext}.
		/// </summary>
		public string TargetPath
		{
			get
			{
				var extension = "." + _context.ProjectIdentifier + PlatformInfo.AssetExtension;
				return RelativePathWithoutExtension + extension;
			}
		}
		...
		{
			get { return Path.Combine(_context.TempDirectory, RelativePathWithoutExtension); }
		}
