namespace Pegasus.AssetsCompiler.Assets
{
	...
	public class Texture2DAsset : TextureAsset
	{
		...
		public Texture2DAsset(CompilationContext context, string relativePath)
		...
		protected Texture2DAsset(CompilationContext context, string relativePath, string sourceDirectory)
			: base(context, relativePath, sourceDirectory)
		{
		}
