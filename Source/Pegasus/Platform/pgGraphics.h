...
PG_API_EXPORT pgSwapChain* pgCreateSwapChain(pgGraphicsDevice* device, pgWindow* window, pgInt32 width, pgInt32 height);
...
PG_API_EXPORT pgShader* pgCreateVertexShader(pgGraphicsDevice* device, pgVoid* shaderData, pgInt32 length);
