namespace Pegasus.Rendering
{
	...
	internal struct Quad
	{
												  ...
												  IndexBuffer indexBuffer)
		{
			...
			{
				new VertexBinding(vertexBuffer, VertexDataFormat.Vector2, DataSemantics.Position, Vertex.Size, 0),
				new VertexBinding(vertexBuffer, VertexDataFormat.Vector2, DataSemantics.TexCoords0, Vertex.Size, 8),
				new VertexBinding(vertexBuffer, VertexDataFormat.Color, DataSemantics.Color0, Vertex.Size, 16)
			};
			...
			: this()
		{
			...
			_bottomLeft.TextureCoordinates = new Vector2(texture.Left, texture.Bottom);
			_bottomRight.TextureCoordinates = new Vector2(texture.Right, texture.Bottom);
			_topLeft.TextureCoordinates = new Vector2(texture.Left, texture.Top);
			_topRight.TextureCoordinates = new Vector2(texture.Right, texture.Top);
		}
