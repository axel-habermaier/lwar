namespace Pegasus.Scripting
{
	...
	internal static class Commands
	{
		...
		public static void Initialize()
		{
			...
			HelpCommand = new Command<string>("help",
				...
				new CommandParameter("name", typeof(string), true, "",
					"The name of the cvar or the command for which the description should be displayed."));
			ResetCommand = new Command<string>("reset", "Resets the given cvar to its default value.", false,
				new CommandParameter("cvar", typeof(string), false, default(string), "The name of the cvar that should be reset to its default value.",
					new NotEmptyAttribute()));
			ListCvarsCommand = new Command<string>("list_cvars", "Lists all cvars with names that match the search pattern.", false,
				new CommandParameter("pattern", typeof(string), true, "*",
					"The search pattern of the cvars that should be listed. For instance, \"draw\" lists all cvars that have the string \"draw\" in their name. The pattern is case-insensitive; use \"*\" to list all cvars.",
					new NotEmptyAttribute()));
			ListCommandsCommand = new Command<string>("list_commands", "Lists all commands with names that match the search pattern.", false,
				new CommandParameter("pattern", typeof(string), true, "*",
					"The search pattern of the commands that should be listed. For instance, \"draw\" lists all commands that have the string \"draw\" in their name. The pattern is case-insensitive; use \"*\" to list all commands.",
					new NotEmptyAttribute()));
			ExecuteCommand = new Command<string>("execute", "Executes the given command.", false,
				new CommandParameter("command", typeof(string), false, default(string), "The command that should be executed, including its arguments.",
					new NotEmptyAttribute()));
			ProcessCommand = new Command<string>("process", "Processes the commands in the given file.", false,
				new CommandParameter("fileName", typeof(string), false, default(string),
					"The name of the file in the application's user directory that should be processed.", new NotEmptyAttribute(), new FileNameAttribute()));
			PersistCommand = new Command<string>("persist", "Saves the persistent cvars into the given file.", false,
				new CommandParameter("fileName", typeof(string), false, default(string),
					"The name of the file in the application's user directory the cvars should be written to.", new NotEmptyAttribute(),
					new FileNameAttribute()));
			PrintAppInfoCommand = new Command("print_app_info", "Prints information about the application.", false);
			BindCommand = new Command<InputTrigger, string>("bind",
				...
				new CommandParameter("command", typeof(string), false, default(string),
					"The command (including the arguments) that should be executed when the trigger is fired.", new NotEmptyAttribute()));
			...
			RestartGraphicsCommand = new Command("restart_graphics", "Restarts the graphics subsystem after a resolution or video mode change.",
				false);
			ToggleCommand = new Command<string>("toggle", "Toggles the value of a Boolean console variable.", false,
				new CommandParameter("cvar", typeof(string), false, default(string), "The name of console variable whose value should be toggled.",
					new NotEmptyAttribute()));
