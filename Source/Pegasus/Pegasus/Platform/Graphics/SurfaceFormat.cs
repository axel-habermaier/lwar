namespace Pegasus.Platform.Graphics
{
	...
	public enum SurfaceFormat
	{
		...
		/// <summary>
		///     Represents a compressed format with 5:6:5 bits of precision for the color channels, and 1 bit for the optional
		///     alpha
		///     channel.
		/// </summary>
		Bc1 = 2151,
		...
		/// <summary>
		///     Represents a compressed format with 5:6:5 bits of precision for the color channels, and 4 bits for the alpha
		///     channel.
		/// </summary>
		Bc2 = 2152,

		/// <summary>
		///     Represents a compressed format with 5:6:5 bits of precision for the color channels, and 8 bits for the alpha
		///     channel.
		/// </summary>
		Bc3 = 2153,
