namespace Pegasus.Entities
{
	...
	public abstract class EntityBehavior<T1, T2, T3, T4> : EntityBehavior, IEventHandler<EntityAddedEvent>, IEventHandler<EntityRemovedEvent>
		where T1 : Component
		where T2 : Component
		where T3 : Component
		where T4 : Component
	{
		...
		protected EntityBehavior(int capacity = 8)
			: this(ComponentDependency.Default, ComponentDependency.Default, ComponentDependency.Default, ComponentDependency.Default, capacity)
		{
		}
		...
		protected EntityBehavior(ComponentDependency componentDependency1, ComponentDependency componentDependency2,
								 ...
								 int capacity = 8)
			: base(4, capacity, componentDependency1, componentDependency2, componentDependency3, componentDependency4)
		{
		}
		...
		void IEventHandler<EntityAddedEvent>.HandleEvent(EntityAddedEvent eventArgs, Entity entity)
		{
			...
			GetComponents(entity, out component1, out component2, out component3, out component4);

			if (!CheckDependency(component1, 0) || !CheckDependency(component2, 1) || !CheckDependency(component3, 2) ||
				!CheckDependency(component4, 3))
				return;
			...
			OnAdded(entity, component1, component2, component3, component4);
		}
		...
		protected virtual void OnAdded(Entity entity, T1 component1, T2 component2, T3 component3, T4 component4)
		{
		}
		...
		protected virtual void OnRemoved(Entity entity, T1 component1, T2 component2, T3 component3, T4 component4)
		{
		}
		...
		{
			Process(Entities, (T1[])Components[0], (T2[])Components[1], (T3[])Components[2], (T4[])Components[3], AffectedEntityCount);
		}
		...
		/// </remarks>
		protected abstract void Process(Entity[] entities, T1[] components1, T2[] components2, T3[] components3, T4[] components4, int count);
