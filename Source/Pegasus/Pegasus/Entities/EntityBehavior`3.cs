namespace Pegasus.Entities
{
	...
	public abstract class EntityBehavior<T1, T2, T3> : EntityBehavior, IEventHandler<EntityAddedEvent>, IEventHandler<EntityRemovedEvent>
		where T1 : Component
		where T2 : Component
		where T3 : Component
	{
		...
		protected EntityBehavior(int capacity = 8)
			: this(ComponentDependency.Default, ComponentDependency.Default, ComponentDependency.Default, capacity)
		{
		}
		...
		protected EntityBehavior(ComponentDependency componentDependency1, ComponentDependency componentDependency2,
								 ComponentDependency componentDependency3, int capacity = 8)
			: base(3, capacity, componentDependency1, componentDependency2, componentDependency3)
		{
		}
		...
		void IEventHandler<EntityAddedEvent>.HandleEvent(EntityAddedEvent eventArgs, Entity entity)
		{
			...
			GetComponents(entity, out component1, out component2, out component3);
			...
			OnAdded(entity, component1, component2, component3);
		}
		...
		void IEventHandler<EntityRemovedEvent>.HandleEvent(EntityRemovedEvent eventArgs, Entity entity)
		{
			...
			OnRemoved(entity, (T1)Components[0][index], (T2)Components[1][index], (T3)Components[2][index]);
			Free(entity, index);
		}
		...
		protected virtual void GetComponents(Entity entity, out T1 component1, out T2 component2, out T3 component3)
		{
		...
		protected virtual void OnAdded(Entity entity, T1 component1, T2 component2, T3 component3)
		{
		}
		...
		protected virtual void OnRemoved(Entity entity, T1 component1, T2 component2, T3 component3)
		{
		}
		...
		{
			Process(Entities, (T1[])Components[0], (T2[])Components[1], (T3[])Components[2], AffectedEntityCount);
		}
		...
		/// </remarks>
		protected abstract void Process(Entity[] entities, T1[] components1, T2[] components2, T3[] components3, int count);
