namespace Tests.Parsing.BasicParsers
{
	...
	public class Float32ParserTests : ParserTestsHelper<float>
	{
		...
		{
			Message("",
				String.Format(NumberParser<float>.OverflowMessage, TypeRegistry.GetDescription<float>()));
		}

		[Test]
		public void Underflow()
		{
			Message("-",
				String.Format(NumberParser<float>.OverflowMessage, TypeRegistry.GetDescription<float>()));
		}
