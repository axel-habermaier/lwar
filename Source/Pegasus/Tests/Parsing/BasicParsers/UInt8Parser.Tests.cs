namespace Tests.Parsing.BasicParsers
{
	...
	[TestFixture]
	public class UInt8ParserTests : ParserTestsHelper<byte>
	{
		public UInt8ParserTests()
			: base(new UInt8Parser())
		{
		}
		...
		{
			Expected("+a", TypeRegistry.GetDescription<byte>());
		}
		...
		{
			Message("111111", String.Format(NumberParser<byte>.OverflowMessage, TypeRegistry.GetDescription<byte>()));
		}
