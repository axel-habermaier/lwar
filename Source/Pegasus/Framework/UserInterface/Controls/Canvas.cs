...
namespace Pegasus.Framework.UserInterface.Controls
{
	...
	public class Canvas : Layout
	{
		...
		/// </summary>
		public static readonly DependencyProperty<double> LeftProperty = new DependencyProperty<double>();
		...
		/// </summary>
		public static readonly DependencyProperty<double> RightProperty = new DependencyProperty<double>();

		/// <summary>
		///   The distance between the top of an UI element and its parent Canvas.
		/// </summary>
		public static readonly DependencyProperty<double> TopProperty = new DependencyProperty<double>();

		/// <summary>
		///   The distance between the bottom of an UI element and its parent Canvas. If the Top property is also set, the Bottom
		///   value is ignored.
		/// </summary>
		public static readonly DependencyProperty<double> BottomProperty = new DependencyProperty<double>();
