namespace Pegasus.Rendering
{
	...
	public struct VertexPositionNormal
	{
		...
		public static VertexInputLayout GetInputLayout(VertexBuffer vertexBuffer, IndexBuffer indexBuffer)
		{
			...
			Assert.That(Marshal.SizeOf(typeof(VertexPositionNormal)) == Size, "Unexpected unmanaged size.");

			var inputElements = new[]
			{
				new VertexInputBinding(vertexBuffer, VertexDataFormat.Vector4, DataSemantics.Position, Size, 0),
				new VertexInputBinding(vertexBuffer, VertexDataFormat.Vector3, DataSemantics.Normal, Size, 16)
			};
