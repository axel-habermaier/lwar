...
//     Thursday, 24 April 2014, 16:48:20
//
...
namespace Pegasus.Scripting
{
	...
	internal static class Commands
	{
		...
		/// </summary>
		public static Command<string> ReloadAssetsCommand { get; private set; }
		...
		/// </param>
		[DebuggerHidden]
		public static void ReloadAssets(string paths)
		{
			Assert.ArgumentNotNull((object)paths);
			ReloadAssetsCommand.Invoke(paths);
		}
		...
		/// </summary>
		public static event Action<string> OnReloadAssets
		{
		...
		public static void Initialize()
		{
			...
			ReloadAssetsCommand = new Command<string>("reload_assets", "Reloads all assets of the given asset projects.", false, 
				new CommandParameter("paths", typeof(string), false, default(string), "The path to the assets project files that should be recompiled and reloaded. Different assets projects should be separated by semicolon.", new NotEmptyAttribute()));
