...
//     Tuesday, 01 April 2014, 15:16:47
//
...
namespace Pegasus.Scripting
{
	...
	internal static class Commands
	{
		...
		public static void Initialize()
		{
			...
			ReloadAssetsCommand = new Command<string>("reload_assets", "Reloads all assets of the given asset project.", false, 
				new CommandParameter("path", typeof(string), false, default(string), "The path to the assets project file that should be recompiled and reloaded.", new NotEmptyAttribute()));
