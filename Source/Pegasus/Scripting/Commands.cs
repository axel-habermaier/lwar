...
//     Wednesday, 02 April 2014, 08:55:13
//
...
namespace Pegasus.Scripting
{
	...
	internal static class Commands
	{
		...
		/// </param>
		[DebuggerHidden]
		public static void ReloadAssets(string path)
		{
			Assert.ArgumentNotNull((object)path);
			ReloadAssetsCommand.Invoke(path);
		}
		...
		public static void Initialize()
		{
			...
			ReloadAssetsCommand = new Command<string>("reload_assets", "Reloads all assets of the given asset projects.", false, 
				new CommandParameter("path", typeof(string), false, default(string), "The path to the assets project files that should be recompiled and reloaded. Different assets projects should be separated by semicolon.", new NotEmptyAttribute()));
