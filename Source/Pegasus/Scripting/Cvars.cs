...
//     Wednesday, 18 December 2013, 12:21:14
//
...
namespace Pegasus.Scripting
{
	...
	internal static class Cvars
	{
		...
		public static void Initialize()
		{
			...
			ShowPlatformInfoCvar = new Cvar<bool>("show_platform_info", PlatformInfo.IsDebug, "Shows or hides the platform information.", UpdateMode.Immediate, true, false);
			ShowFrameStatsCvar = new Cvar<bool>("show_frame_stats", PlatformInfo.IsDebug, "Shows or hides the frame statistics.", UpdateMode.Immediate, true, false);
