...
namespace LibNoise.Demo
{
	...
	public partial class FrmMain : Form
	{
		...
		protected void GenerateNoise()
		{
			...
			BitmapAdapter bmShapeAdaptater = new BitmapAdapter(bmpShape);
			...
			*/
			...
			// ------------------------------------------------------------------------------------------------
			// 2 - Render image
			// Create a renderer, BitmapAdapter create a System.Drawing.Bitmap on the fly
			watchDog.Reset();
			_prbarRenderProgression.Value = 0;
			...
			//
			/*
			BitmapAdapter nmapAdaptater = new BitmapAdapter(width, height);
