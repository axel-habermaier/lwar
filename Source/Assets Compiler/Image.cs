...
namespace Pegasus.AssetsCompiler
{
	...
	/// <summary>
	///   Represents an image that can be stored in the Pegasus texture format.
	/// </summary>
	internal abstract class Image : DisposableObject
	{
		/// <summary>
		///   Gets or sets the texture description of the image.
		/// </summary>
