namespace Lwar.AssetsCompiler.EntityTemplates.Compilation
{
	...
	using Pegasus.AssetsCompiler.AssetCompilers;
	...
	internal class EntityTemplateCompiler : IAssetCompiler
	{
		...
		public Asset CreateAsset(CompilationContext context, Dictionary<string, string> metadata)
		{
			return null;
		}
		...
		public void Clean(IEnumerable<Asset> assets)
		{
