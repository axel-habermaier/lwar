...
namespace Lwar.Client.Scripting
{
	...
	public class CommandRegistry : Pegasus.Framework.Scripting.CommandRegistry
	{
		...
		public void ShowScoreboard(bool show)
		{
			...
			Instances.ShowScoreboard.Invoke(show);
		}
		...
		{
			add { Instances.Say.Invoked += value; }
			remove { Instances.Say.Invoked -= value; }
		}
		...
		/// </summary>
		public event Action<bool> OnShowScoreboard
		{
			add { Instances.ShowScoreboard.Invoked += value; }
			remove { Instances.ShowScoreboard.Invoked -= value; }
		}
		...
		protected override void Initialize(object instances)
		{
			...
			Register(Instances.Say, "say");
			Register(Instances.ToggleDebugCamera, "toggle_debug_camera");
			Register(Instances.ShowScoreboard, "show_scoreboard");
		}
		...
		public new class InstanceList : Pegasus.Framework.Scripting.CommandRegistry.InstanceList
		{
			...
			public InstanceList()
			{
				StartServer = new Command("start_server", "Starts up a new local server instance. If a local server is currently running, it is shut down before the new server is started.");
				...
				Say = new Command<string>("say", "Sends a chat message to all peers.", 
				...
				ShowScoreboard = new Command<bool>("show_scoreboard", "Shows or hides the scoreboard during an active game session.", 
					new CommandParameter("show", typeof(bool), false, default(bool), "If true, the scoreboard is shown."));
			}
			...
			///   Sends a chat message to all peers.
			/// </summary>
			public Command<string> Say { get; private set; }
			...
			///   Shows or hides the scoreboard during an active game session.
			/// </summary>
			public Command<bool> ShowScoreboard { get; private set; }
		}
	}
}
