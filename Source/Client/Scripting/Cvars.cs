...
namespace Lwar.Client.Scripting
{
	...
	internal static class Cvars
	{
		...
		public static void Initialize()
		{
			...
			DrawWireframeCvar = new Cvar<bool>("draw_wireframe", false, "If true, all 3D geometry is drawn in wireframe mode.", UpdateMode.Immediate, false, false);
			...
			InputTurnLeftCvar = new Cvar<InputTrigger>("input_turn_left", Key.A.IsPressed() | Key.Left.IsPressed(), "When triggered in an active game session, turns the player to the left.", UpdateMode.Immediate, true, false);
			InputTurnRightCvar = new Cvar<InputTrigger>("input_turn_right", Key.D.IsPressed() | Key.Right.IsPressed(), "When triggered in an active game session, turns the player to the right.", UpdateMode.Immediate, true, false);
			InputStrafeLeftCvar = new Cvar<InputTrigger>("input_strafe_left", Key.Q.IsPressed(), "When triggered in an active game session, moves the player to the left.", UpdateMode.Immediate, true, false);
			InputStrafeRightCvar = new Cvar<InputTrigger>("input_strafe_right", Key.E.IsPressed(), "When triggered in an active game session, moves the player to the right.", UpdateMode.Immediate, true, false);
