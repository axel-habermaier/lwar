...
//     Wednesday, 05 June 2013, 16:19:22
//
...
namespace Lwar.Client.Scripting
{
	...
	internal static class Cvars
	{
		...
		/// </summary>
		public static event CvarChangingHandler<string> PlayerNameChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<string> PlayerNameChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<bool> DrawWireframeChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<bool> DrawWireframeChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<double> EventMessageDisplayTimeChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<double> EventMessageDisplayTimeChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<double> ChatMessageDisplayTimeChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<double> ChatMessageDisplayTimeChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<InputTrigger> InputShowScoreboardChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<InputTrigger> InputShowScoreboardChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<InputTrigger> InputForwardChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<InputTrigger> InputForwardChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<InputTrigger> InputBackwardChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<InputTrigger> InputBackwardChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<InputTrigger> InputTurnLeftChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<InputTrigger> InputTurnLeftChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<InputTrigger> InputTurnRightChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<InputTrigger> InputTurnRightChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<InputTrigger> InputStrafeLeftChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<InputTrigger> InputStrafeLeftChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<InputTrigger> InputStrafeRightChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<InputTrigger> InputStrafeRightChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<InputTrigger> InputPrimaryWeaponChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<InputTrigger> InputPrimaryWeaponChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<InputTrigger> InputSecondaryWeaponChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<InputTrigger> InputSecondaryWeaponChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<InputTrigger> InputTertiaryWeaponChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<InputTrigger> InputTertiaryWeaponChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<InputTrigger> InputQuaternaryWeaponChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<InputTrigger> InputQuaternaryWeaponChanged
		{
		...
		/// </summary>
		public static event CvarChangingHandler<InputTrigger> InputChatChanging
		{
		...
		/// </summary>
		public static event CvarChangedHandler<InputTrigger> InputChatChanged
		{
		...
		public static void Initialize()
		{
			...
			InputShowScoreboardCvar = new Cvar<InputTrigger>("input_show_scoreboard", Key.Tab.IsPressed(), "When triggered in an active game session, shows the scoreboard.", UpdateMode.Immediate, true);
			InputForwardCvar = new Cvar<InputTrigger>("input_forward", Key.W.IsPressed() | Key.Up.IsPressed(), "When triggered in an active game session, moves the player forwards.", UpdateMode.Immediate, true);
			InputBackwardCvar = new Cvar<InputTrigger>("input_backward", Key.S.IsPressed() | Key.Down.IsPressed(), "When triggered in an active game session, moves the player backwards.", UpdateMode.Immediate, true);
			InputTurnLeftCvar = new Cvar<InputTrigger>("input_turn_left", Key.A.IsPressed() | Key.Left.IsPressed(), "When triggered in an active game session, turns the player to the left.", UpdateMode.Immediate, true);
			InputTurnRightCvar = new Cvar<InputTrigger>("input_turn_right", Key.D.IsPressed() | Key.Right.IsPressed(), "When triggered in an active game session, turns the player to the right.", UpdateMode.Immediate, true);
			InputStrafeLeftCvar = new Cvar<InputTrigger>("input_strafe_left", Key.Q.IsPressed(), "When triggered in an active game session, moves the player to the left.", UpdateMode.Immediate, true);
			InputStrafeRightCvar = new Cvar<InputTrigger>("input_strafe_right", Key.E.IsPressed(), "When triggered in an active game session, moves the player to the right.", UpdateMode.Immediate, true);
			InputPrimaryWeaponCvar = new Cvar<InputTrigger>("input_primary_weapon", MouseButton.Left.IsPressed(), "When triggered in an active game session, fires the player's primary weapon.", UpdateMode.Immediate, true);
			InputSecondaryWeaponCvar = new Cvar<InputTrigger>("input_secondary_weapon", MouseButton.Right.IsPressed(), "When triggered in an active game session, fires the player's secondary weapon.", UpdateMode.Immediate, true);
			InputTertiaryWeaponCvar = new Cvar<InputTrigger>("input_tertiary_weapon", Key.Num1.IsPressed(), "When triggered in an active game session, fires the player's tertiary weapon.", UpdateMode.Immediate, true);
			InputQuaternaryWeaponCvar = new Cvar<InputTrigger>("input_quaternary_weapon", Key.Num2.IsPressed(), "When triggered in an active game session, fires the player's quaternary weapon.", UpdateMode.Immediate, true);
			InputChatCvar = new Cvar<InputTrigger>("input_chat", Key.Return.WentDown() | Key.NumpadEnter.WentDown(), "When triggered in an active game session, opens the chat input.", UpdateMode.Immediate, true);
		...
		public static void Resolve()
		{
			...
			WindowStateFlagCvar = CvarRegistry.Resolve<WindowState>("window_state_flag");
