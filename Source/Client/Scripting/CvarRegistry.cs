...
//     Saturday, April 6, 2013, 19:19:39
//
...
namespace Lwar.Client.Scripting
{
	...
	public class CvarRegistry : Pegasus.Framework.Scripting.CvarRegistry
	{
		...
		public new class InstanceList : Pegasus.Framework.Scripting.CvarRegistry.InstanceList
		{
			...
			public InstanceList()
			{
				PlayerName = new Cvar<string>("player_name", "UnnamedPlayer", "The name of the player that identifies the player in networked games.", true, new NotEmptyAttribute(), new MaximumLengthAttribute(Specification.MaximumPlayerNameLength, true));
