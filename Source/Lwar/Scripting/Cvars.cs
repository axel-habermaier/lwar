...
//     Wednesday, 13 August 2014, 12:11:31
//
...
namespace Lwar.Scripting
{
	...
	internal static class Cvars
	{
		...
		/// </summary>
		public static Cvar<ConfigurableInput> InputTurnLeftCvar { get; private set; }

		/// <summary>
		///     When triggered in an active game session, turns the player to the right.
		/// </summary>
		public static Cvar<ConfigurableInput> InputTurnRightCvar { get; private set; }
		...
		///     When triggered in an active game session, turns the player to the left.
		/// </summary>
		public static ConfigurableInput InputTurnLeft
		{
		...
		///     When triggered in an active game session, turns the player to the right.
		/// </summary>
		public static ConfigurableInput InputTurnRight
		{
		...
		/// </summary>
		public static event Action<ConfigurableInput> InputTurnLeftChanging
		{
		...
		/// </summary>
		public static event Action<ConfigurableInput> InputTurnLeftChanged
		{
		...
		/// </summary>
		public static event Action<ConfigurableInput> InputTurnRightChanging
		{
		...
		/// </summary>
		public static event Action<ConfigurableInput> InputTurnRightChanged
		{
		...
		public static void Initialize()
		{
			...
			InputTurnLeftCvar = new Cvar<ConfigurableInput>("input_turn_left", Key.Q, "When triggered in an active game session, turns the player to the left.", UpdateMode.Immediate, true, false);
			InputTurnRightCvar = new Cvar<ConfigurableInput>("input_turn_right", Key.E, "When triggered in an active game session, turns the player to the right.", UpdateMode.Immediate, true, false);
