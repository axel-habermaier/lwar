...
//     Monday, 11 August 2014, 11:31:58
//
...
namespace Lwar.Scripting
{
	...
	internal static class Cvars
	{
		...
		/// </summary>
		public static Cvar<Key> InputShowScoreboardCvar { get; private set; }
		...
		/// </summary>
		public static Cvar<Key> InputChatCvar { get; private set; }
		...
		///     When triggered in an active game session, shows the scoreboard.
		/// </summary>
		public static Key InputShowScoreboard
		{
		...
		/// </summary>
		public static event Action<Key> InputShowScoreboardChanging
		{
		...
		/// </summary>
		public static event Action<Key> InputShowScoreboardChanged
		{
		...
		/// </summary>
		public static event Action<Key> InputChatChanging
		{
		...
		/// </summary>
		public static event Action<Key> InputChatChanged
		{
		...
		public static void Initialize()
		{
			...
			InputShowScoreboardCvar = new Cvar<Key>("input_show_scoreboard", Key.Tab, "When triggered in an active game session, shows the scoreboard.", UpdateMode.Immediate, true, false);
			InputForwardCvar = new Cvar<InputTrigger>("input_forward", Key.W.IsPressed(), "When triggered in an active game session, moves the player forwards.", UpdateMode.Immediate, true, false);
			InputBackwardCvar = new Cvar<InputTrigger>("input_backward", Key.S.IsPressed(), "When triggered in an active game session, moves the player backwards.", UpdateMode.Immediate, true, false);
			...
			InputChatCvar = new Cvar<Key>("input_chat", Key.Return, "When triggered in an active game session, opens the chat input.", UpdateMode.Immediate, true, false);
