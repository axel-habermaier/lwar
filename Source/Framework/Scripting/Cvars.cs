...
//     Wednesday, 05 June 2013, 17:59:19
//
...
namespace Pegasus.Framework.Scripting
{
	...
	internal static class Cvars
	{
		...
		public static void Initialize()
		{
			...
			ResolutionCvar = new Cvar<Size>("resolution", new Size(1024, 768), "The screen resolution used by the application in fullscreen mode. Any changes to this cvar require a restart of the graphics subsystem.", UpdateMode.OnGraphicsRestart, true, new WindowSizeAttribute());
