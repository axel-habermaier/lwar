...
//     Thursday, 06 June 2013, 15:19:56
//
...
namespace Pegasus.Framework.Scripting
{
	...
	internal static class Cvars
	{
		...
		public static void Initialize()
		{
			...
			ResolutionCvar = new Cvar<Size>("resolution", new Size(1024, 768), "The screen resolution used by the application in fullscreen mode.", UpdateMode.OnGraphicsRestart, true, new WindowSizeAttribute());
			FullscreenCvar = new Cvar<bool>("fullscreen", !PlatformInfo.IsDebug, "If true, the application is run in fullscreen mode.", UpdateMode.OnGraphicsRestart, true);
			WindowSizeCvar = new Cvar<Size>("window_size", new Size(1024, 768), "The size in pixels of the application window in non-fullscreen mode.", UpdateMode.Immediate, true, new WindowSizeAttribute());
			WindowPositionCvar = new Cvar<Vector2i>("window_position", Vector2i.Zero, "The screen position of the application window's top left corner in non-fullscreen mode.", UpdateMode.Immediate, true, new WindowPositionAttribute());
			WindowModeCvar = new Cvar<WindowState>("window_mode", WindowState.Normal, "The width of the application's window in non-fullscreen mode.", UpdateMode.Immediate, true);
