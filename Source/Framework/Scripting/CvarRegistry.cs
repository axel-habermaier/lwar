	...
	public class CvarRegistry : Registry<ICvar>
	{
		...
		public new class InstanceList : Registry<ICvar>.InstanceList
		{
			...
			public InstanceList()
			{
				...
				ResolutionWidth = new Cvar<int>("resolution_width", 640, "The width of the screen resolution used by the application.", true, new RangeAttribute(640, 1920));
				ResolutionHeight = new Cvar<int>("resolution_height", 360, "The height of the screen resolution used by the application.", true, new RangeAttribute(360, 1200));
