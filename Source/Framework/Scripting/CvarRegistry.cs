	...
	public partial class CvarRegistry : Registry<ICvar>
	{
		...
		public new class InstanceList : Registry<ICvar>.InstanceList
		{
			...
			public InstanceList()
			{
				...
				ResolutionWidth = new Cvar<int>("resolution_width", 640, "The width of the screen resolution used by the application in fullscreen mode. Any changes to this cvar require a restart of the graphics subsystem.", UpdateMode.OnGraphicsRestart, true, new RangeAttribute(320, 4096));
				ResolutionHeight = new Cvar<int>("resolution_height", 360, "The height of the screen resolution used by the application in fullscreen mode. Any changes to this cvar require a restart of the graphics subsystem.", UpdateMode.OnGraphicsRestart, true, new RangeAttribute(240, 4096));
