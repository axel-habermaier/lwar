...
//     Thursday, April 4, 2013, 14:07:57
//
...
namespace Pegasus.Framework.Scripting
{
	...
	public class CvarRegistry2 : CvarRegistry
	{
		...
		/// </summary>
		private readonly Cvar<int> _appVersionMajor = new Cvar<int>("app_version_major", default(int), "The applications major version number.");

		/// <summary>
		///   The applications minor version number.
		/// </summary>
		private readonly Cvar<int> _appVersionMinor = new Cvar<int>("app_version_minor", 1, "The applications minor version number.");
		...
		/// </summary>
		private readonly Cvar<string> _playerName = new Cvar<string>("player_name", "UnnamedPlayer", "The name of the player.");

		/// <summary>
		///   A cvar that indicates whether network debugging is enabled.
		/// </summary>
		private readonly Cvar<bool> _networkDebugging = new Cvar<bool>("network_debugging", PlatformInfo.IsDebug, "A cvar that indicates whether network debugging is enabled.");

		/// <summary>
		///   The scaling factor that is applied to all timing values.
		/// </summary>
		private readonly Cvar<double> _timeScaleFactor = new Cvar<double>("time_scale_factor", 1.0, "The scaling factor that is applied to all timing values.");
