...
//     Tuesday, 13 August 2013, 21:34:24
//
...
namespace Pegasus.Framework.Scripting
{
	...
	internal static class Commands
	{
		...
		public static void Initialize()
		{
			...
			HelpCvar = new Command<string>("help", "Describes the usage and the purpose of the the cvar or command with the given name. If no name is given, displays a help text about the usage of cvars and commands in general.", false, 
			...
			BindCvar = new Command<InputTrigger, string>("bind", "Binds a command invocation to a logical input. Whenever the input is triggered, the command is invoked with the specified arguments.", false, 
