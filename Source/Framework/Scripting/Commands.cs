...
namespace Pegasus.Framework.Scripting
{
	...
	internal static class Commands
	{
		...
		public static void Initialize()
		{
			...
			UnbindCvar = new Command<InputTrigger>("unbind", "Unbinds all commands currently bound to the logical input.", false, 
			...
			ToggleStatsCvar = new Command("toggle_stats", "Toggles the visiblity of the statistics.", false);
