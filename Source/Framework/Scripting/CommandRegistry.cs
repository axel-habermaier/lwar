...
//     Saturday, April 6, 2013, 16:30:45
//
...
namespace Pegasus.Framework.Scripting
{
	...
	public class CommandRegistry : Registry<ICommand>
	{
		...
		public void Test(string n, int j, int i)
		{
			Instances.Test.Invoke(n, j, i);
		}
		...
		/// </summary>
		public event Action<string, int, int> OnTest
		{
		...
		public new class InstanceList : Registry<ICommand>.InstanceList
		{
			...
			public InstanceList()
			{
				...
				Help = new Command<string>("help", "Describes the usage and the purpose of the the cvar or command with the given name.", 
					new CommandParameter("name", typeof(string), false, default(string), "The name of the cvar or the command for which the description should be displayed."));
				Test = new Command<string, int, int>("test", "asdf", 
					new CommandParameter("n", typeof(string), false, default(string), "fd"), 
					new CommandParameter("j", typeof(int), false, default(int), "fd"), 
					new CommandParameter("i", typeof(int), true, 22, "fd"));
			...
			///   asdf
			/// </summary>
			public Command<string, int, int> Test { get; private set; }
